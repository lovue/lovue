(function (Vue) {
  ...
  /* template */
  var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-img-reflex"},[_c('div',{staticClass:"img-wrap"},[_c('img',{attrs:{"src":_vm.src,"alt":_vm.alt}})]),_vm._v(" "),_vm._m(0)])};
  var __vue_staticRenderFns__ = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"reflex-wrap"},[_c('div',{staticClass:"reflex"}),_vm._v(" "),_c('div',{staticClass:"reflex-gradient"})])}];
    ...
    function __vue_normalize__(
      ...
      component.__file = "ImgReflex.vue";
    ...
    var ImgReflex = __vue_normalize__(
  ...
  var __vue_staticRenderFns__$1 = [];
    ...
    function __vue_normalize__$1(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "SelectCity.vue";
    ...
    var SelectCity = __vue_normalize__$1(
  ...
  /* template */
  var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-collapse"},_vm._l((_vm.items),function(item,i){return _c('div',{staticClass:"c-item",class:{open: item._open}},[_c('div',{staticClass:"c-head",on:{"click":function($event){_vm.select(i);}}},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(item._show),expression:"item._show"}],staticClass:"c-body"},[_vm._v(_vm._s(item.content))])])}))};
  var __vue_staticRenderFns__$2 = [];
    ...
    var Collapse = __vue_normalize__$2(
  ...
  var __vue_staticRenderFns__$3 = [];
    ...
    function __vue_normalize__$3(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "EditorSvg.vue";
    ...
    var EditorSvg = __vue_normalize__$3(
  ...
  /* template */
  var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-html-editor"},[_c('editor-svg'),_vm._v(" "),(_vm.bShowOverlay)?_c('v-popup',{attrs:{"title":"预览结果"},model:{value:(_vm.bShowOverlay),callback:function ($$v) {_vm.bShowOverlay=$$v;},expression:"bShowOverlay"}},[_c('div',{staticClass:"content",attrs:{"slot":"content"},domProps:{"innerHTML":_vm._s(_vm.contentHTML)},slot:"content"})]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"e-toolbar"},[_c('v-button',{attrs:{"type":"text","title":"撤销","icon":"fa-undo"},on:{"click":function($event){_vm.formatDoc('undo');}}}),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"重做","icon":"fa-redo"},on:{"click":function($event){_vm.formatDoc('redo');}}}),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"清除格式","icon":"fa-eraser"},on:{"click":_vm.removeFormat}}),_vm._v(" "),_c('v-button',{ref:"bold",attrs:{"type":"text","title":"加粗","icon":"fa-bold"},on:{"click":function($event){_vm.formatDoc('bold');}}}),_vm._v(" "),_c('v-button',{ref:"italic",attrs:{"type":"text","title":"斜体","icon":"fa-italic"},on:{"click":function($event){_vm.formatDoc('italic');}}}),_vm._v(" "),_c('v-button',{ref:"underline",attrs:{"type":"text","title":"下划线","icon":"fa-underline"},on:{"click":function($event){_vm.formatDoc('underline');}}}),_vm._v(" "),_c('v-button',{ref:"strikeThrough",attrs:{"type":"text","title":"删除线"},on:{"click":function($event){_vm.formatDoc('strikeThrough');}}},[_c('del',[_vm._v("abc")])]),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"缩退","icon":"fa-outdent"},on:{"click":function($event){_vm.formatDoc('outdent');}}}),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"缩进","icon":"fa-indent"},on:{"click":function($event){_vm.formatDoc('indent');}}}),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"超链接","icon":"fa-link"},on:{"click":_vm.insertLink}}),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"分隔线"},on:{"click":function($event){_vm.formatDoc('insertHorizontalRule');}}},[_vm._v("—")]),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"图片","icon":"fa-picture"},on:{"click":_vm.insertImage}}),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.currentBlock),expression:"currentBlock"}],staticClass:"select",on:{"change":[function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.currentBlock=$event.target.multiple ? $$selectedVal : $$selectedVal[0];},function($event){_vm.formatDoc('formatBlock',$event.target.value);}]}},_vm._l((_vm.headList),function(head){return _c('option',{domProps:{"value":head}},[_vm._v(_vm._s(head))])})),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"源码"},on:{"click":_vm.toggleSource}},[_vm._v("HTML")]),_vm._v(" "),_c('v-button',{attrs:{"type":"text","title":"预览"},on:{"click":_vm.preview}},[_vm._v("预览")]),_vm._v(" "),_c('ul')],1),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.sourceMode),expression:"!sourceMode"}],staticClass:"e-content",attrs:{"id":"editorContent","contenteditable":""},on:{"click":_vm.checkStatus,"paste":_vm.removeFormat,"keyup":[function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"up",38,$event.key,["Up","ArrowUp"])){ return null; }return _vm.checkStatus($event)},function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"down",40,$event.key,["Down","ArrowDown"])){ return null; }return _vm.checkStatus($event)},function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"left",37,$event.key,["Left","ArrowLeft"])){ return null; }if('button' in $event && $event.button !== 0){ return null; }return _vm.checkStatus($event)},function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"right",39,$event.key,["Right","ArrowRight"])){ return null; }if('button' in $event && $event.button !== 2){ return null; }return _vm.checkStatus($event)},function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.checkStatus($event)}]}}),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.sourceMode),expression:"sourceMode"}],staticClass:"e-source"},[_c('pre',[_c('code',[_vm._v(_vm._s(_vm.sourceCode))])])])],1)};
  var __vue_staticRenderFns__$4 = [];
    ...
    function __vue_normalize__$4(
      ...
      // For security concerns, we use only base name in production mode.
      component.__file = "HtmlEditor.vue";
    ...
    var HtmlEditor = __vue_normalize__$4(
