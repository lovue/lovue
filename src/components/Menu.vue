    ...
    <li class="v-menu-item" v-for="menu of menus">
      <template v-if="vertical">
        <template v-if="menu.children">
          <div class="i-title" :class="{focus: menu._focus}" @click="toggleMenu(menu)">{{menu.name}} <v-icon icon="down-wide" :class="{up: menu._openIcon}"></v-icon></div>
        ...
        <a :class="{focus: menu._focus}" :href="menu.url" v-else>{{menu.name}}</a>
      </template>
      <template v-else>
        <div class="v-dropdown-wrap" v-if="menu.children">
          <div class="d-trigger" :class="{focus: menu._focus}">{{menu.name}} <v-icon icon="down-wide"></v-icon></div>
